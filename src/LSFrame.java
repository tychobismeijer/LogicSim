...
public class LSFrame extends JInternalFrame implements java.awt.event.ActionListener {
    ...
    "---", I18N.getString("GATE_BINARYINPUT"), I18N.getString("GATE_LCD"), I18N.getString("GATE_SEVENSEGMENT"),   I18N.getString("GATE_TEXTLABEL"), I18N.getString("GATE_RANDOMGENERATOR"), "---"};
    ...
    LSPanel.ACTION_ONDELAY, LSPanel.ACTION_OFFDELAY, 0, LSPanel.ACTION_BININ, LSPanel.ACTION_LCD, LSPanel.ACTION_SEVENSEGMENT,LSPanel.ACTION_TEXTLABEL, LSPanel.ACTION_RANDOMGENERATOR, 0 };
